# PASSATION — Tarjih — ARCHIVE (entrées anciennes, déplacées depuis PASSATION.md quand il dépasse 150 Ko)

> Ordre : la plus récente en tête. Les entrées vivantes sont dans PASSATION.md.
